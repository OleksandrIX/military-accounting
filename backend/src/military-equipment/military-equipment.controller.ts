...
export class MilitaryEquipmentController {
  ...
  @Post()
  async createMilitaryEquipment(dto: CreateMilitaryEquipmentDto) {
    return await this.militaryEquipmentRepository.save({ ...dto });
  }

  @Put()
  async changeMilitaryEquipment(militaryEquipment: MilitaryEquipment) {
    return await this.militaryEquipmentRepository.update(militaryEquipment.id, militaryEquipment);
  }

  @Delete()
  async deleteMilitaryEquipment(militaryEquipment: MilitaryEquipment) {
